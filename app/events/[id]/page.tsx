      ...
      >
        <div className="bg-black/50 w-full py-6 px-4 text-white">
          ...
          <p className="text-gray-200">
            {event.cities?.formatted_name ?? "Unknown location"} • {start}
          </p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto py-10 space-y-6">
        ...
        <div className="border rounded-lg p-4 space-y-2">
          ...
          <p className="text-gray-600">
            ...
            {event.cities?.formatted_name ?? "Unknown"}
          </p>

          <p className="text-gray-600">
            <span className="font-semibold">Venue:</span>{" "}
            {event.venues?.name ?? "Unknown"} —{" "}
            {event.venues?.address ?? "No address"}
          </p>
        ...
        {Array.isArray(event.event_styles) &&
        ...
        {event.venues?.lat != null && event.venues?.lng != null && (
          <div>
